#!/usr/bin/env python3
"""Day 2: Ingestion + specification lock support + QA for county-year panel.
...
def main() -> None:
    ...
    if (qa["pass"] == 0).any():
        ...
        raise RuntimeError(f"Day2 QA fail-stop triggered. Failed checks: {failed}")

    print("Day2 ingestion complete. QA checks passed.")
