#!/usr/bin/env python3
"""Day 4: Baseline model estimation + diagnostics (efficient TWFE implementation)."""
...
def plot_event(es: pd.DataFrame, path: Path) -> None:
    ...
    ax.set_title("Day4 Event Study: Remote Work vs Broadband Adoption")
...
def main() -> None:
    ...
    print("Day4 baseline model outputs written.")
